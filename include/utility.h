...
public:
    ...
    bool enableAdaptiveFeatureSelection;
    float cornerFeatureRatio;
    float surfaceFeatureRatio;
    float curvatureRangeWeight;
    ...
    ParamServer()
    {
        ...
        nh.param<bool>("lio_sam/enableAdaptiveFeatureSelection", enableAdaptiveFeatureSelection, true);
        nh.param<float>("lio_sam/cornerFeatureRatio", cornerFeatureRatio, 0.04);
        nh.param<float>("lio_sam/surfaceFeatureRatio", surfaceFeatureRatio, 0.2);
        nh.param<float>("lio_sam/curvatureRangeWeight", curvatureRangeWeight, 0.6);
